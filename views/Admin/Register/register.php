...
<body ng-app="myFrontend" ng-controller = 'homeController'  ng-init="flag=false"  class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a href="<?php echo base_url().'index.php/admin/register';?>"><i class="la la-th-large"></i><span class="menu-title" data-i18n="">Register</span></a>
                </li>
        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Payment IPN Table</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo base_url().'index.php/admin';?>">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Register Table
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div ng-if="flag"class="alert alert-danger mb-2" role="alert">
                                        ...
                                        <table id="active-accounts" class="table alt-pagination table-wrapper">
                                            ...
                                            <tbody>
                                                <?php $index = 0; foreach($register_list as $register){ $index ++; ?>
                                                <tr>
                                                    
                                                    <!-- <td><input type="checkbox" class="input-chk" name="checkName" value="<?=$product->productId;?>"></td> -->
                                                    <td class="align-middle"><?php echo $index;?></td>
                                                    <td class="align-middle"><?=$register->customerName;?></td>
                                                    <td class="align-middle"><?=$register->item_qty?></td>
                                                    <td class="align-middle"><?=$register->txn_id;?></td>
                                                    <td class="align-middle"><?=$register->payment_gross;?></td>
                                                    <td class="align-middle"><?=$register->currency_code;?></td>
                                                    <td class="align-middle"><?=$register->payer_email;?></td>

                                                    <!-- <td class="text-truncate">
                                                        <span class="avatar avatar-xs">
                                                            <img class="box-shadow-2" src="<?php echo base_url().'assets/app-assets/images/portrait/small/'.$register->userImg;?>" alt="avatar">
                                                        </span>
                                                        <span><?=$register->userName;?></span>
                                                    </td> -->
                                                    <!-- <td class="align-middle">
                                                        <div class="action">
                                                            <a ng-click="editBtn('<?=$category->categoryId?>')"><i class="la la-pencil-square success"></i></a>
                                                            <a ng-click="deleteBtn('<?=$category->categoryId?>')"><i class="la la-trash danger"></i></a>
                                                        </div>
                                                    </td> -->
                                                </tr>
                                                <?php } ?>
    ...
    App.controller('homeController', function($scope, $http){
        $scope.editBtn = function(data){
            ...
            // }else{
                $scope.flag = false;
                location.assign(base_url + 'index.php/admin/category/edit/' + data);
            // }
        }
        ...
        //    }else{
               ...
               $http.post(base_url + 'index.php/admin/category/del',JSON.stringify(temp_data)).then(function (response){
