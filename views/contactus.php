            ...
            <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-block--contact-info">
                  ...
                  <p><a href="#">info@excessyard.com</a><span>&nbspDubai,UAE</span></p>
                </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-block--contact-info">
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-block--contact-info">
                  ...
                  <p><a href="#">info@excessyard.com</a><span>(800) 843-2446</span></p>
                </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-block--contact-info">
                  <h4>Media Relations</h4>
                  <p><a href="#">info@excessyard.com</a><span>(801) 947-3564</span></p>
                </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                <div class="ps-block--contact-info">
                  <h4>Vendor Support</h4>
                  <p><a href="#">info@excessyard.com</a><span>(801) 947-3100</span></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="ps-footer__copyright">
          <div class="row">
            ...
            <a  href="<?php echo base_url()?>" ><img style="width:80px;"src="<?php echo base_url().'assets/img/Artwork.png'?>" alt=""> &nbsp;© 2019 EXCESS YARD<span style="color:rgb(59,185,116)"> All Rights Reserved</span></a>
